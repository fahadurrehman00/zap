      ...
      <div className='col-span-6'>
        <div className='flex items-center justify-between mb-4'>
          ...
          <div className='flex space-x-2'>
            <MdOutlineKeyboardArrowLeft className='cursor-pointer text-lg bg-white rounded-full p-1 hover:bg-[#003C0F] hover:text-white' />
            <MdOutlineKeyboardArrowRight className='cursor-pointer text-lg bg-white rounded-full p-1 hover:bg-[#003C0F] hover:text-white' />
          </div>
        </div>
